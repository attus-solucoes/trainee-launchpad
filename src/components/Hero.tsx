    ...
    <section id="hero" aria-label="Início" className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden mesh-gradient">
      ...
      <div className="relative z-10 container mx-auto px-4 lg:px-8 text-center flex flex-col items-center pt-24 pb-16">
        ...
        <h1
          ...
          style={{ fontSize: "clamp(2.25rem, 6vw, 4.5rem)", animationDelay: "0.1s", animationFillMode: "both" }}
        >
        ...
        <div className="flex flex-col sm:flex-row items-center gap-4 animate-fade-up" style={{ animationDelay: "0.3s", animationFillMode: "both" }}>
          <a
            href="#inscricao"
